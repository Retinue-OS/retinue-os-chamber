...
Continued from [`cycles-001-044.md`](cycles-001-044.md); continues in
[`cycles-124-182.md`](cycles-124-182.md), and the live log picks up at cycle 183.

*(This line originally read "the live log picks up at cycle 124". It was correct
when written and became wrong on 2026-07-26, when cycles 124–182 rotated into
part 3. Corrected then, and noted here rather than silently, because everything
below it is verbatim and the distinction matters.)*
