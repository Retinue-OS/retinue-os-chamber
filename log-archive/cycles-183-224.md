# Aros — activity log, archive part 4: 2026-07-26 to 2026-07-28 (cycles 183–224)

Rotated out of `log.md` on 2026-07-28 (cycle 231), under the rule `log.md`'s own
preamble states: past 300 KB, whole entries move here oldest-first until the live
file is back under 50 KB. This rotation ran at 273 KB rather than waiting for the
threshold — the margin was ~27 KB, about four and a half cycles at the measured
6.0 KB per entry, which is the same margin cycle 190 rotated on. A rotation done
early is identical to one done late except that nobody has to catch it in time.
